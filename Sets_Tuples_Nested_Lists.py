...
# You can not accesss elements in a set by index because sets are unordered
# Instread you can convert the ste to a list and access elements by index
list1 = list(set1)
#print(list(0))
#We use sets when we want to store unique elemements
#We dont care about the order of the elements
#do not want the elements to be changed

# add elements to a set
print(set1.add(6)) # Output: {1,2,3,4,5,6}
print(set2.add("orange")) # Output: {'apple', 'banana', 'cherry', 'orange'}
print(set3.add("Melon"))
print(set4.add(1))
